...
# with some modifications for my custom needs
...
sudo scutil --set ComputerName "CHANGE-ME"
sudo scutil --set HostName "CHANGE-ME"
sudo scutil --set LocalHostName "CHANGE-ME"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "CHANGE-ME"
